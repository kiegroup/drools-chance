...
public class DomainModelSupport {
	...
	static {
		registerAdapter(new StraightThroughDomainModelAdapter(Question.QuestionType.TYPE_TEXT, String.class));
		...
		registerAdapter(new StraightThroughDomainModelAdapter(Question.QuestionType.TYPE_DATE, Date.class));
	 ...
	 * @return
	 */
	public static Object answerToObject(Question.QuestionType answerType, Object answer, Class<?> clazz) {
	 ...
	 * @return
	 */
	public static Object objectToAnswer(Object object, Question.QuestionType answerType) {
		if (object == null) {
			return null;
		}
	 ...
	 * @return
	 */
	public static Question.QuestionType classToAnswerType(Class<?> clazz) {
		DomainModelAdapter adapter = adapters.get(createAdapterKey(clazz));
		if (adapter == null) {
