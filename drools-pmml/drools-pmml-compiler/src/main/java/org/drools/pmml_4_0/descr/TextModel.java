...
public class TextModel implements Serializable
{
    ...
    protected List<Serializable> extensionsAndDocumentTermMatrixesAndTextCorpuses;
    @XmlAttribute
     ...
     * 
     */
    public List<Serializable> getExtensionsAndDocumentTermMatrixesAndTextCorpuses() {
        if (extensionsAndDocumentTermMatrixesAndTextCorpuses == null) {
            extensionsAndDocumentTermMatrixesAndTextCorpuses = new ArrayList<Serializable>();
        }
