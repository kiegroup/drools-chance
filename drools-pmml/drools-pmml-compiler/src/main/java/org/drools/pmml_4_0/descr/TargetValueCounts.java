 ...
 *         &lt;element ref="{http://www.dmg.org/PMML-4_0}TargetValueCount" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable
{
    ...
    protected List<TargetValueCount> targetValueCounts;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the targetValueCounts property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTargetValueCounts().add(newItem);
     * </pre>
     * 
     * 
     * <p>
