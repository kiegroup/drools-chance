 ...
 *         &lt;element ref="{http://www.dmg.org/PMML-4_0}MiningField" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class MiningSchema implements Serializable
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the miningFields property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMiningFields().add(newItem);
     * </pre>
     * 
     * 
     * <p>
