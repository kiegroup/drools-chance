...
import org.drools.pmml_4_1.PMML4Wrapper;
...
public class HeaderTest extends DroolsAbstractPMMLTest {
    ...
    public void testPMMLHeader() {
		...
		PMML4Wrapper wrapper = new PMML4Wrapper();
			wrapper.setPack("org.drools.pmml_4_1.test");
        ...
        KnowledgePackage pack = ksession.getKnowledgeBase().getKnowledgePackage("org.drools.pmml_4_1.test");
        assertNotNull(pack);
