...
public class NeuralNetworkTest extends DroolsAbstractPMMLTest {
    ...
    private static final String source1 = "org/drools/pmml_4_1/test_ann_regression.xml";

    //
    private static final String source3 = "org/drools/pmml_4_1/test_miningSchema.xml";
    private static final String source2 = "org/drools/pmml_4_1/test_ann_iris.xml";

    private static final String source22 = "org/drools/pmml_4_1/test_ann_iris_v2.xml";
    private static final String source23 = "org/drools/pmml_4_1/test_ann_iris_prediction.xml";
    private static final String source4 = "org/drools/pmml_4_1/test_ann_mixed_inputs2.xml";

    private static final String source6 = "org/drools/pmml_4_1/mock_ptsd.xml";
    private static final String source7 = "org/drools/pmml_4_1/mock_cold.xml";
    private static final String source8 = "org/drools/pmml_4_1/mock_breastcancer.xml";

    private static final String packageName = "org.drools.pmml_4_1.test";

    private static final String smartVent = "org/drools/pmml_4_1/smartvent.xml";
    ...
    public void testANNFromSource() throws Exception {
        ...
        knowledgeBuilder.add( new ClassPathResource( "org/drools/pmml_4_1/ann_rules.drl"), ResourceType.DRL );
...
//                queryStringField("NSPECIES_Iris_versicolor", "IRIS_MLP"));
    ...
    public void testOverride() throws Exception {
        ...
        FactType out1 = getKbase().getFactType("org.drools.pmml_4_1.test","Out1");
        FactType out2 = getKbase().getFactType("org.drools.pmml_4_1.test","Out2");
        FactType nump = getKbase().getFactType("org.drools.pmml_4_1.test","Feat2");
