...
public class Minus extends AbstractConnective {
    ...
    private static org.drools.chance.rule.constraint.core.connectives.impl.godel.And and = org.drools.chance.rule.constraint.core.connectives.impl.godel.And.getInstance();
    private static Not not = Not.getInstance();
    ...
    public Degree eval(Degree left, Degree right) {
        return and.eval( left, not.eval( right ) );
    }
