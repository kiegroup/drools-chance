package org.drools.chance.rule.constraint.core.connectives.factories.fuzzy.mvl;
...
import org.drools.chance.rule.constraint.core.connectives.impl.lukas.*;
...
public class ManyValuedConnectiveFactory implements ConnectiveFactory {
    ...
    static {
        ...
        addKnownClass( org.drools.chance.rule.constraint.core.connectives.impl.godel.Minus.class );
        ...
        addKnownClass( org.drools.chance.rule.constraint.core.connectives.impl.lukas.Minus.class );
        ...
        addKnownClass( org.drools.chance.rule.constraint.core.connectives.impl.product.Minus.class );
    ...
    public ConnectiveCore getConnective(LogicConnectives conn, String type, Object... params) {
        switch ( conn ) {
            ...
            case MINUS: return getMinus(type, params);
    ...
    public ConnectiveCore getAnd( String type, Object... params ) {
        ...
        switch ( family ) {
            ...
            default:        return org.drools.chance.rule.constraint.core.connectives.impl.lukas.And.getInstance();
        }
    }
    ...
    public ConnectiveCore getOr( String type, Object... params ) {
        ...
        switch ( family ) {
            ...
            default:        return org.drools.chance.rule.constraint.core.connectives.impl.lukas.Or.getInstance();
        }
    }
    ...
    public ConnectiveCore getNot( String type, Object... params ) {
        MvlFamilies family = MvlFamilies.valueOf(type);
        switch ( family ) {
            case GODEL:     return org.drools.chance.rule.constraint.core.connectives.impl.godel.Not.getInstance();
            case LUKAS:     return org.drools.chance.rule.constraint.core.connectives.impl.lukas.Not.getInstance();
            case PRODUCT:   return org.drools.chance.rule.constraint.core.connectives.impl.product.Not.getInstance();
            default:        return org.drools.chance.rule.constraint.core.connectives.impl.lukas.Not.getInstance();
        }
    }
    ...
    public ConnectiveCore getMinus( String type, Object... params ) {
        ...
        switch ( family ) {
            ...
            default:        return org.drools.chance.rule.constraint.core.connectives.impl.lukas.Minus.getInstance();
        }
    }
