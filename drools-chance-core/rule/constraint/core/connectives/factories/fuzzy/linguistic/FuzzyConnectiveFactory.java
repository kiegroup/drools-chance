...
public class FuzzyConnectiveFactory implements ConnectiveFactory {
    ...
    public ConnectiveCore getAnd() {
        return org.drools.chance.rule.constraint.core.connectives.impl.godel.And.getInstance();
    }
    ...
    public ConnectiveCore getAnd( String type, Object... params ) {
        ...
        switch ( family ) {
            ...
            default:        return org.drools.chance.rule.constraint.core.connectives.impl.godel.And.getInstance();
        }
    }

    public ConnectiveCore getOr() {
        return org.drools.chance.rule.constraint.core.connectives.impl.godel.Or.getInstance();
    }
    ...
    public ConnectiveCore getOr( String type, Object... params ) {
        ...
        switch ( family ) {
            ...
            default:        return org.drools.chance.rule.constraint.core.connectives.impl.godel.Or.getInstance();
        }
    }

    public ConnectiveCore getNot() {
        return org.drools.chance.rule.constraint.core.connectives.impl.godel.Not.getInstance();
    }
    ...
    public ConnectiveCore getNot( String type, Object... params ) {
        ...
        switch ( family ) {
            ...
            default:        return org.drools.chance.rule.constraint.core.connectives.impl.godel.Not.getInstance();
        }
    }


    public ConnectiveCore getMinus() {
        return org.drools.chance.rule.constraint.core.connectives.impl.godel.Minus.getInstance();
    }
    ...
    public ConnectiveCore getMinus( String type, Object... params ) {
        ...
        switch ( family ) {
            ...
            default:        return org.drools.chance.rule.constraint.core.connectives.impl.godel.Minus.getInstance();
        }
    }
