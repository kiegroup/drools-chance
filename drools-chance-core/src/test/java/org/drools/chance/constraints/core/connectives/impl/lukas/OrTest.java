...
public class OrTest extends TestCase {
    ...
    IConnectiveCore or = org.drools.chance.constraints.core.connectives.impl.lukas.Or.getInstance();
       ...
       public void testGetInstance() throws Exception {
           Or or2 = org.drools.chance.constraints.core.connectives.impl.lukas.Or.getInstance();
...
public void testType() throws Exception {
       ...
       public void testEvalBinarySimple() throws Exception {
           ...
           assertEquals(new SimpleDegree(0.8),s0);
       }
       ...
       public void testEvalBinaryInterval() throws Exception {
           ...
           assertEquals(new IntervalDegree(0.75,1.0),s0);
       }
       ...
       public void testEvalNarySimple() throws Exception {
           ...
           assertNotNull(s0);
           assertTrue(s0 instanceof SimpleDegree);
           assertEquals(new SimpleDegree(0.9),s0);
       }
       ...
       public void testEvalNaryInterval() throws Exception {
           ...
           assertNotNull(s0);
           assertTrue(s0 instanceof IntervalDegree);
           assertEquals(new IntervalDegree(0.85,1.0),s0);
       }
