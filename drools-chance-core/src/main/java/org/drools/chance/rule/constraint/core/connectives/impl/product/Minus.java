...
public class Minus extends AbstractConnective {
    ...
    private static And and = org.drools.chance.rule.constraint.core.connectives.impl.godel.And.getInstance();
    private static Not notL = org.drools.chance.rule.constraint.core.connectives.impl.lukas.Not.getInstance();
